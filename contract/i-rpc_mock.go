...
func (m *MockIRpc) CallWithoutResponseError(arg0 string, arg1 interface{}) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CallWithoutResponseError", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockIRpcMockRecorder) CallWithoutResponseError(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CallWithoutResponseError", reflect.TypeOf((*MockIRpc)(nil).CallWithoutResponseError), arg0, arg1)
}
